    ...
    <div class="login-box">
      ...
      <form method="POST" action="login.php" autocomplete="off" id="login-form">
        ...
        <div class="form-group">
          ...
          <div class="input-wrap">
            <span class="input-icon">
              <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-lock">
            ...
            <button type="button" class="toggle-pass" id="toggle-pass" title="Tampilkan Password">
              <span id="eye-icon">
                <svg xmlns="http://www.w3.org/2000/svg" class="feather feather-eye eye-open" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                  <path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"></path>
                  <circle cx="12" cy="12" r="3"></circle>
                </svg>
                <svg xmlns="http://www.w3.org/2000/svg" class="feather feather-eye-off eye-closed" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" style="display: none;">
