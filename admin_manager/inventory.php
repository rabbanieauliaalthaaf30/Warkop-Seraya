...
<body class="page-inventory-mgr">
  ...
  <div class="sidebar">
    ...
    <ul>
      ...
      <li><a href="laporan_stok.php"><i data-feather="bar-chart-2"></i> Laporan Stok</a></li>
  ...
  <div class="main">
    ...
    <!-- Tab navigation -->
    <div class="inv-tabs">
      <button class="inv-tab-btn active" onclick="switchTab('stok', this)">
        <i data-feather="package"></i>
        Kondisi Stok Saat Ini
        <span class="tab-badge"><?= $total_item ?></span>
      </button>
      <button class="inv-tab-btn" onclick="switchTab('riwayat', this)">
